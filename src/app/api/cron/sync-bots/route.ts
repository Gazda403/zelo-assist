...
export async function GET(request: Request) {
    try {
        ...
        // We use a simple bearer token check.
        // In Vercel CRON, we can check for CRON_SECRET header or query param.
        // For development, we can allow manual trigger if secret matches.
        ...
        // 3. Process each user in parallel (or sequential to avoid rate limits?)
        // Sequential is safer for reliability + logging.
        // Parallel is faster.
