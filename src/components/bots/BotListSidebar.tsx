                ...
                {!searchQuery && (
                    <div className="mb-4 space-y-2">
                        ...
                        <div
                            ...
                            className="p-3.5 rounded-2xl border transition-all cursor-pointer group hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)] hover:-translate-y-0.5 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-md hover:bg-white dark:hover:bg-zinc-800 border-gray-200/50 dark:border-white/5 hover:border-violet-200 dark:hover:border-violet-500/30"
                        >
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-1">Investors & cold sales. High safety, no meetings.</p>
                        </div>
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-1">Shopify & WooCommerce. Orders, returns & Q&A.</p>
                        </div>
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-1">Auto-responses via templates. AI handling.</p>
                        </div>
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-1">Monitors threads and suggests follow-up drafts.</p>
                        </div>
                    </div>
                )}
                ...
                <div className="space-y-2">
                    ...
                    {filteredBots.length === 0 ? (
                        <div className="text-center py-10 text-gray-400">
                            {searchQuery ? <p>No bots match "{searchQuery}"</p> : <div><p className="mb-2">No bots yet</p><button onClick={onCreateNew} className="text-violet-600 hover:underline text-sm">Create your first bot</button></div>}
                        </div>
                    ) : (
                        filteredBots.map((bot, index) => (
                            <motion.div key={bot.id} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: index * 0.05 }}>
                                <BotCard
                                    bot={bot}
