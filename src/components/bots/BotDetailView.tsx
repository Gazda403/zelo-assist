...
import { Settings, Activity, Info, Trash2, Power, Clock, Book, Brain } from 'lucide-react';
import type { EmailBot } from '@/lib/bots/types';
import { deleteBotAction, toggleBotAction, acceptBotTermsAction, updateBotAction } from '@/app/actions/bots';
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <button
                                ...
                                disabled={isToggling}
                                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium transition-all disabled:opacity-50 ${bot.enabled
                        ...
                        {(bot.id === 'preset_startup_bot' || bot.name.includes('Startup Bot') || bot.name.includes('Founders Bot')) ? (
                            ...
                            <div className="space-y-6">
                                <div className="grid grid-cols-4 gap-4">
                                    <motion.div whileHover={{ y: -2 }} className="p-5 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-xl rounded-2xl border border-violet-100/50 dark:border-white/5 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-[0_4px_20px_rgb(0,0,0,0.2)] transition-all">
                                        <div className="text-3xl font-black text-violet-600 dark:text-violet-400">{bot.stats.totalExecutions}</div>
                                        <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1">Total Runs</div>
                                    </motion.div>
                                    <motion.div whileHover={{ y: -2 }} className="p-5 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-xl rounded-2xl border border-violet-100/50 dark:border-white/5 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-[0_4px_20px_rgb(0,0,0,0.2)] transition-all">
                                        <div className="text-3xl font-black text-green-600 dark:text-green-400">{bot.stats.successCount}</div>
                                        <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1">Successful</div>
                                    </motion.div>
                                    <motion.div whileHover={{ y: -2 }} className="p-5 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-xl rounded-2xl border border-violet-100/50 dark:border-white/5 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-[0_4px_20px_rgb(0,0,0,0.2)] transition-all">
                                        <div className="text-3xl font-black text-blue-600 dark:text-blue-400">{bot.stats.emailsSent}</div>
                                        <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1">Emails Sent</div>
                                    </motion.div>
                                    <motion.div whileHover={{ y: -2 }} className="p-5 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-xl rounded-2xl border border-violet-100/50 dark:border-white/5 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-[0_4px_20px_rgb(0,0,0,0.2)] transition-all">
                                        <div className="text-3xl font-black text-purple-600 dark:text-purple-400">{bot.stats.draftsCreated}</div>
                                        <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1">Drafts Created</div>
                                    </motion.div>
                                </div>
                                ...
                                <div className="bg-white/80 dark:bg-zinc-800/80 backdrop-blur-xl rounded-2xl border border-violet-100/50 dark:border-white/5 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-[0_4px_20px_rgb(0,0,0,0.2)] p-6 transition-all hover:shadow-[0_8px_30_rgb(0,0,0,0.06)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.25)]">
