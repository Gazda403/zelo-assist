        ...
        <div className="space-y-6 pb-12 rounded-none font-sans mt-4 transition-colors">
            ...
            >
                <div className="grid grid-cols-12 divide-x divide-zinc-200 dark:divide-zinc-800">
                    ...
                    <div className="col-span-12 lg:col-span-5 p-8 space-y-8">
                        <div>
                            ...
                            {[
                                ...
                                <div key={item.label} className="group cursor-default">
                                    ...
                                    <div className="flex items-baseline gap-3">
                                        <span className="text-4xl font-black text-zinc-900 dark:text-zinc-100 group-hover:text-fuchsia-500 transition-colors">{item.value}</span>
                    ...
                    <div className="col-span-12 lg:col-span-7 p-8 bg-zinc-50/50 dark:bg-zinc-950/20 relative">
