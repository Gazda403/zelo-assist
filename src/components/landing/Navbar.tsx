    ...
    return (
        <>
            <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
                <nav className="pointer-events-auto h-12 md:h-14 px-3 md:px-8 flex items-center justify-between gap-2 md:gap-4 bg-white/45 dark:bg-zinc-900/45 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-full shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] w-full max-w-4xl mx-auto transition-all duration-300 hover:bg-white/55 dark:hover:bg-zinc-900/55 hover:shadow-[0_8px_32px_0_rgba(31,38,135,0.1)]">
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                        ...
                        {status === 'authenticated' ? (
                            ...
                            <button
                                ...
                                className="relative px-3.5 sm:px-5 py-2 md:py-2.5 text-xs md:text-sm font-semibold text-gray-900 bg-primary rounded-full overflow-hidden group transition-all hover:scale-105 active:scale-95 shadow-lg shadow-primary/20 cursor-pointer whitespace-nowrap flex-shrink-0"
                            >
