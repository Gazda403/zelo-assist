    ...
    return (
        <section className="py-24 relative overflow-hidden bg-slate-950">
            ...
            <div className="container mx-auto px-4 max-w-5xl relative z-10">
                <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2rem] sm:rounded-[3rem] p-6 md:p-16 text-center shadow-2xl overflow-hidden relative group transition-all duration-500 hover:border-white/20">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-white font-medium text-sm mb-6 sm:mb-8 backdrop-blur-md border border-white/10">
                            <Sparkles className="w-4 h-4 text-accent" />
                            <span>Reclaim your time</span>
                        </div>

                        <h2 className="text-3xl sm:text-4xl md:text-6xl font-serif font-bold text-white mb-6 sm:mb-8 leading-[1.1]">
                            Ready to liberate<br />your inbox?
                        </h2>

                        <p className="text-lg sm:text-xl text-slate-400 mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed italic font-serif">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                            <motion.button
                                ...
                                className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-white text-slate-950 font-bold rounded-2xl flex items-center justify-center gap-3 shadow-xl shadow-white/10 transition-shadow hover:shadow-white/20 active:shadow-inner"
                            >
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-transparent text-white font-bold border border-white/20 rounded-2xl flex items-center justify-center gap-3 backdrop-blur-md transition-all hover:bg-white/10"
                            >
                                Book a Demo
                            </motion.button>
                        </div>
