...
const plans = [
    {
        name: "Free",
        price: "$0",
        description: "7 days trial, then sequencing stays free forever",
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {'alwaysFreeFeature' in plan && (plan as any).alwaysFreeFeature && (
                                                <div className="mb-4 flex items-center gap-2 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl px-3 py-2.5">
                                                    <div className="w-4 h-4 rounded-full bg-emerald-500 flex items-center justify-center shrink-0">
                                                        <Infinity className="w-2.5 h-2.5 text-white stroke-[2.5px]" />
                                                    </div>
                                                    <div>
                                                        <p className="text-[11px] font-bold text-emerald-800 leading-tight">{(plan as any).alwaysFreeFeature}</p>
                                                        <p className="text-[9px] text-emerald-600 mt-0.5">Even after your trial ends</p>
                                                    </div>
                                                </div>
                                            )}
